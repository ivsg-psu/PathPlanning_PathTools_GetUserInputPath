...
% into the function
if iscell(hLine)
    oldSecondary = hLine{2};
    delete(oldSecondary);
    temp = new_hLine;
    new_hLine = cell(2,1);
    new_hLine{1} = temp;
    new_hLine{2} = gobjects(0);
end
...
for ith_subpath = 1:NsubPaths
    ...
    if flag_isGeoPlot
        ...
        hQuiverObjects(ith_subpath*3-2) = geoplot(ax, ...
        ...
        hQuiverObjects(ith_subpath*3-1) = geoplot(ax, ...
        ...
        hQuiverObjects(ith_subpath*3) = geoplot(ax, ...
