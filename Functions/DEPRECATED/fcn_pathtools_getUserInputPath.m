...
MATLABFLAG_GETUSERINPUTPATH_WARN_GETUSERINPUTPATH = getenv("MATLABFLAG_GETUSERINPUTPATH_WARN_GETUSERINPUTPATH");
flagShowWarning = 0;
if isempty(MATLABFLAG_GETUSERINPUTPATH_WARN_GETUSERINPUTPATH) 
   flagShowWarning = 1;
else
    if strcmp('1',MATLABFLAG_GETUSERINPUTPATH_WARN_GETUSERINPUTPATH)
        flagShowWarning = 1;
    end
end
...
if 1==flagShowWarning
    ...
    warning(['fcn_pathtools_getUserInputPath is being deprecated. ' ...
        'Use fcn_GetUserInputPath_getUserInputPath instead.']);
    setenv('MATLABFLAG_GETUSERINPUTPATH_WARN_GETUSERINPUTPATH','0');
end
