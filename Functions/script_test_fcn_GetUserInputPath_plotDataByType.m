% script_test_fcn_GetUserInputPath_plotDataByType
% This is a script to exercise the function:
% fcn_GetUserInputPath_plotDataByType.m
%
...
% REVISION HISTORY:
%
% As: script_test_fcn_GetUserInputPath_plotDataByType
%
% 2026_06_08 by Sean Brennan, sbrennan@psu.edu
% - In script_test_fcn_GetUserInputPath_plotDataByType
...
%% DEMO case: non-empty data and empty inputType
figNum = 10002;
titleString = sprintf('DEMO case: non-empty data and empty inputType');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;
...
data = [0 0; 1 1; 0 1; nan nan; 2 2; 0 4; -1 3];
inputType = 'patch';
hPoints = fcn_GetUserInputPath_plotDataByType(data,(inputType),(figNum));
...
hPoints = fcn_GetUserInputPath_getUserInputPath((data),(figNum),'patch');
...
data = rand(10,2);
hPoints = fcn_GetUserInputPath_getUserInputPath((data),(figNum));
...
if 1==0
    ...
    try
    	fcn_GetUserInputPath_getUserInputPath((data),(figNum),'invalid_input_type');
    ...
    data = [];
    hPoints = fcn_GetUserInputPath_getUserInputPath((data),(figNum),'aabb');
