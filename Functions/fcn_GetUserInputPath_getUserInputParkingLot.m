...
networkLinkagePaths = { ...
	'pavedCenterPath',...
	'laneCenterPath',...
	'oneWayParkingAislePath',...
	'twoWayParkingAislePath',...
	'entranceJunctionLine',...
	'exitJunctionLine',...
	'parkingTerminalLine',...
	};
...
paintedStripes = { ...
	...
	'frontParkingStopStripes_physical', ...
	'noParkingStripes_physical', ...
	'noParkingStripes_implied', ...
	'parkingRestrictedStripes_handicapped', ...
	'parkingRestrictedStripes_special',...
	'directionalArrowStripes_physical',...
	'directionalArrowStripes_implied',...
	'stopLineStripes_physical',...
	'stopLineStripes_implied',...
	'pedestrianCrosswalkStripes_physical',...
	'pedestrianCrosswalkStripes_implied',... % Typically 
	'pedestrianSidewalkStripes',... % Typically white corridor parallel to road
	'bicycleLaneStripes',... % Typically white corridor parallel to road
	'coloredCurbStripes_red',... % No parking, stopping, fire lanes, etc
	'coloredCurbStripes_blue',... % Handicapped / disabled
	'coloredCurbStripes_white',... % Loading, unloading, passenger pick-up
	'coloredCurbStripes_yellow',... % Loading, unloading, passenger pick-up
	'coloredCurbStripes_green',... % Short term parking
	'speedBump_yellowStripes',... marking used to denote speed bump
	'speedBump_whiteStripes',... marking used to denote speed bump
	'cartCorralStripes', ... % location of areas designated for returning shopping carts
	'loadingAndUnloadingZoneStripes'};
...
physicalBarriers = { ...
	...
	'entranceBarrier_physical',...
	'exitBarrier_physical',...
	'pedestrianCrosswalkRaised_physical',...
	'bollardsTemporary_physical', ... % short thick posts designed to block vehicles
	'bollardsPermanent_physical', ... % short thick posts designed to block vehicles
	'lightingPoles', ... % location of lighting poles - typically concrete or metal
	'telephonePoles', ... % location of telephone poles - typically wood
	'buildingWallsAndPillars', ... % location of buildings/walls/pillars that limit parking
	'cartCorralCages', ... % location of areas designated for returning shopping carts
	'tensionCables', ... % location of tension cables that impede vehicle motion
	'entryTicketKioskBarrier',...
	'exitTicketKioskBarrier',...
	'entryGateBarrier',...
	'exitGateBarrier',...
	'entryGarageDoorBarrier',...
	'exitGarageDoorBarrier',...
	'lowHeadroomBarrier',...
	'EVchargingStationBarrier',...
	'wallBarrier',... % walls inside or near parking
	};
...
boundaryDefinitions = { ...
	...
	'noParkingBoundaries_physical', ...
	'noParkingBoundaries_implied', ...
	'parkingRestrictedBoundaries_handicapped', ...
	'parkingRestrictedBoundaries_special',...
	'pedestrianCrosswalkBoundaries_physical',...
	'pedestrianCrosswalkBoundaries_implied',...
	'pedestrianSidewalkBoundaries',...
	'bicycleLaneBoundaries',...
	'loadingAndUnloadingZoneBoundaries',... % Loading, unloading, passenger pick-up
	'shortTermParkingBoundaries',... % Short term parking
	'cartCorralBoundaries', ... % location of areas designated for returning shopping carts
	'buildingOrWallBoundaries', ... % a wall adjacent to parking lot that would prevent intrustion even if axle is not up against surface
	'entryTicketKioskBoundaries',...
	'exitTicketKioskBoundaries',...
	'entryGateBoundaries',...
	'exitGateBoundaries',...
	'entryGarageDoorBoundaries',...
	'exitGarageDoorBoundaries',...
	'EVchargingStationBoundaries'
	};

roadSurfaceFeatures = { ...
	'asphaultSurfaceBoundaries',...
	'concreteSurfaceBoundaries',...
	'unpavedSurfaceBoundaries',...
	...
	'raisedPedestrianCrosswalks_physical',...
	'raisedEntryExitKiosk_physical',...
	'raisedEntryExitKiosk_physical',...
	'pedestrianSidewalk_concrete',...
