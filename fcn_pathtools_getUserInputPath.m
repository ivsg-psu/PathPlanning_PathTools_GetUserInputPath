function pathXY = fcn_pathtools_getUserInputPath(fig_num, varargin)
...
if isempty(callback_type)
    ...
    fcn_pathtools_getUserInputPath_startPlot(fig_num);
...
function fcn_pathtools_getUserInputPath_startPlot(fig_num)
...
set(current_fig, 'WindowButtonMotionFcn',...
    @fcn_pathtools_getUserInputPath, ...
    'WindowButtonDownFcn',@fcn_pathtools_getUserInputPath);
end
